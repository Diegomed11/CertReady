// Command server arranca el servicio progress como servidor HTTP.
package main
...
import (
	...
	"github.com/certready/certready/services/progress/internal/config"
	"github.com/certready/certready/services/progress/internal/httpapi"
	"github.com/certready/certready/services/progress/internal/store"
	"github.com/certready/certready/services/progress/migrations"
)
...
// buildAuth construye el autenticador OIDC si hay emisor configurado; si no,
// devuelve nil y las rutas protegidas responderán 501.
